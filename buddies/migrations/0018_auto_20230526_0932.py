...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='buddy',
            name='availability',
            field=models.CharField(choices=[('Morning', 'Morning'),
                                            ('Afternoon', 'Afternoon'),
                                            ('Both', 'Both')],
        ...
        migrations.AlterField(
            model_name='buddy',
            name='game_type',
            field=models.CharField(choices=[('Singles', 'Singles'),
                                            ('Doubles', 'Doubles'),
                                            ('Both', 'Both')],
                                   default='Singles', max_length=10),
        ),
        migrations.AlterField(
            model_name='buddy',
            name='gender',
            field=models.CharField(choices=[('M', 'Male'),
                                            ('F', 'Female')],
                                   default='M', max_length=6),
        ),
        migrations.AlterField(
            model_name='buddy',
            name='level',
            field=models.CharField(choices=[('Beginner', 'Beginner'),
