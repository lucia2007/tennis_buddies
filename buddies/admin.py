...
class BuddyAdmin(SummernoteModelAdmin):
    ...
    list_display = ('get_user_name', 'is_approved', 'status', 'gender', 'level', 'game_type', 'availability', 'practice_type', 'created_on')
...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('first_name', 'last_name', 'phone', 'created_on')
