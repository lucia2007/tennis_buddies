...
class BuddyAdmin(SummernoteModelAdmin):
    ...
    list_display = ('get_user_name', 'status', 'gender', 'level', 'game_type', 'availability', 'practice_type', 'created_on')
...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('first_name', 'last_name', 'email', 'phone', 'created_on')
    list_filter = ('first_name', 'created_on')
    search_fields = ['first_nane', 'last_name', 'email', 'phone']
